...
export const PAYMENT_STATUS_COLORS: { [key in PaymentStatus]: string } = {
  ...
  [PaymentStatus.PartiallyPaid]: 'bg-orange-100 text-orange-800',
  [PaymentStatus.Unpaid]: 'bg-red-100 text-red-800',
};

export const ICONS = {
  patients: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M15 21a6 6 0 00-9-5.197M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>,
  ...
  prescriptions: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" /></svg>,
  ...
  edit: <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.5L16.732 3.732z" /></svg>,
...
export const DOCTOR_INFO = {
    name: 'Dr. Onkar Bhave',
    qualifications: 'M.B.B.S., M.D., M.S. | Reg. No: 270988',
    phone: 'Mob. No: 8983390126'
};

export const CLINIC_INFO = {
    name: 'Care Clinic',
    logo: <svg className="h-12 w-12 text-cyan-600" viewBox="0 0 100 100" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M50 0C22.4 0 0 22.4 0 50s22.4 50 50 50 50-22.4 50-50S77.6 0 50 0zm25 55h-20v20h-10V55H25v-10h20V25h10v20h20v10z"/></svg>,
    address: 'Near Axis Bank, Kothrud, Pune - 411038.',
    phone: 'Ph: 094233 80390',
    timing: 'Timing: 09:00 AM - 02:00 PM | Closed: Thursday'
};
